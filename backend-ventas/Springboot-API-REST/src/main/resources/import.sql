...
-- 🚚 Órdenes históricas que YA tienen un camión asignado en la tabla de despachos (despacho_generado = 1)
...
-- ⏳ Órdenes nuevas PENDIENTES listas para procesar en tu examen (despacho_generado = 0)
