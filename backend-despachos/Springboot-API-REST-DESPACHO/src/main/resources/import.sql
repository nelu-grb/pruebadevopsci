...
-- 🚚 Despachos en tránsito o con incidencias (despachado = 0 significa "Despacho abierto/En ruta")
...
-- 📦 Despachos históricos ya finalizados con éxito (despachado = 1 significa "Despacho cerrado/Entregado")
-- Se mantendrán visibles en tu tabla en color verde para demostrar el historial sin desaparecer
